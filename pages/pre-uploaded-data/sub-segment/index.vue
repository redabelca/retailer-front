...
<template>
  <div>
    <PageHeader title="Pre Uploaded Data" />
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">Filter Example</h4>
        <div class="form-row">
          <b-form-group class="col-md-6" label="ID" label-for="id">
            <b-form-input type="text" id="id" placeholder="ID"></b-form-input>
          </b-form-group>
        ...
        <div class="d-flex justify-content-end">
          <b-button variant="success">
            <span class="btn-label"
              ><em class="mdi mdi-filter-outline"></em></span
            >Filter
          </b-button>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-body">
        <h4 class="header-title">CRUD Example</h4>
        <div class="d-flex justify-content-end mb-4">
          <nuxt-link to="/pre-uploaded-data/sub-segment/create">
            <b-button variant="success">
              <span class="btn-label"
                ><em class="mdi mdi-plus fs-big"></em></span
              >Add Example
            </b-button>
          </nuxt-link>
        </div>
          ...
          >
            <template #cell(actions)>
              <b-button variant="info">
                <nuxt-link
                  class="text-white"
                  to="/pre-uploaded-data/sub-segment/single"
                >
              ...
              <b-button variant="success">
                <nuxt-link
                  class="text-white"
                  to="/pre-uploaded-data/sub-segment/create"
                >
